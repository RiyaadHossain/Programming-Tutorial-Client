      ...
      <div>
        ...
        >
          <div className='flex flex-col w-full max-w-xs'>
            ...
            <input defaultValue={blog.name} type='text' id='name' {...register("name")} />
          </div>
          <div className='flex flex-col w-full max-w-xs'>
            <label className='mb-2' htmlFor='image'>
              Image
            </label>
            <input defaultValue={blog.image} type='text' name='image' id='image' {...register("image")} />
          </div>
          ...
          <div className='flex flex-col w-full max-w-xs'>
            ...
            <input defaultValue={blog.time} type='number' name='time' id='time' {...register("time")} />
          </div>
          ...
          <div className='flex flex-col w-full max-w-xs'>
            ...
            <input defaultValue={blog.details} type='text' name='details' id='details' {...register("details")} />
          </div>
